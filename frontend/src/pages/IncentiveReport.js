...
function StaffDetail({ s, onBack }) {
  ...
  return (
    <div className="report-wrap">
      <button className="report-back" onClick={onBack}>← Back to Incentive Report</button>
        ...
        <div className="ai-inner">
          ...
          <p className="ai-text">
            ...
            {s.incentive.bonus3000 > 0
              ...
              ? `Tier 1 bonus unlocked. ${fmt(remaining)} more jars to unlock Tier 2. Current earnings: ${fmt(s.incentive.total)} K.`
        ...
        <>
          ...
          <div className="table-card" style={{ marginBottom: "2rem" }}>
            ...
            <div style={{ overflowX: "auto" }}>
              <table className="data-table">
                <thead>
                  <tr><th>Rank</th><th>Name</th><th>Jars Sold</th><th>Target Progress</th><th>Status</th><th>Base Pay</th><th>Bonuses</th><th>Total Earnings</th></tr>
                </thead>
                <tbody>
                  {staff.map((s, i) => {
                    const pct = Math.round((s.jarsSold / TARGET) * 100);
